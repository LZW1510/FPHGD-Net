from model_file.FPHGD_Net_Tiny import *
...
##########################SET PARSER##################################################
######################################################################################
parser = ArgumentParser(description="FPHGD-NET-TINY")
...
parser.add_argument("--end_learning_rate", type=float, default=1e-5, help="end learning rate")
parser.add_argument("--weight_decay", type=float, default=1e-3, help="end learning rate")
parser.add_argument("--group_num", type=int, default=1, help="group number for training")
parser.add_argument("--cs_ratio", type=int, default=10, help="from{1,5,10,30,50}")
...
#model detail
parser.add_argument("--model_name", type=str, default="FPHGD_Net_Tiny", help="trained or pre-trained model")
parser.add_argument("--channel", type=int, default=16, help="the network channel")
parser.add_argument("--layer_num", type=int, default=16, help="the network layer")
...
model_dir = "./save_model/%s/group_%d_ratio_%d_cropsize_%d_blocksize_%d_method_%s_phase_%d" % (
    model_name, group_num, cs_ratio, crop_size, block_size, design_method, layer_num)
