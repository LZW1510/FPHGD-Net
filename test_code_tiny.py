...
total_p = sum([p.nelement() for p in model.parameters()])
print(total_p)
######################################################################################
############################SET DIR###################################################
######################################################################################
...
state_dict = torch.load('./%s/net_params_%d.pkl' % (model_dir, epoch_num), map_location=device)
